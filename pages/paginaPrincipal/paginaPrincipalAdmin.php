        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
              ...
              <div class="container-xxl d-flex h-100">
                <ul class="menu-inner">
                  ...
                  <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                      <li class="menu-item">
                        <a href="../metasDiarias/listaDeMetasDiarias.php" class="menu-link">
                          <i class='menu-icon bx bx-bullseye'></i>
            ...
            <?php
                ...
                $buscarStock = $pdo->prepare("SELECT usuarios.usuarios_nombre, usuarios.usuarios_apellido, clientes.*
                FROM clientes
                INNER JOIN usuarios ON clientes.Rela_usuario = usuarios.Id_usuarios;
                ");
                $buscarStock->execute();
            ?>
                ...
                <table id="datatable" class="datatables-users table border-top table-bordered" data-page-length="10">
                    ...
                    <?php while ($row = $buscarStock->fetch(PDO::FETCH_ASSOC)): ?>
                        <tr>
                            ...
                            <td><?php echo $row['usuarios_nombre']; ?> <?php echo $row['usuarios_apellido']; ?></td>
