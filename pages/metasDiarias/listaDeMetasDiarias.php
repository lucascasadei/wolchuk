              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="../../php/login/salir.php" target="">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <aside id="layout-menu" class="layout-menu-horizontal menu-horizontal menu bg-menu-theme flex-grow-0">
              <div class="container-xxl d-flex h-100">
                <ul class="menu-inner">
                  ...
                  <li class="menu-item">
                    <a href="javascript:void(0)" class="menu-link menu-toggle">
                    <i class='menu-icon bx bx-bullseye'></i>
                      <div data-i18n="Metas diarias">Metas diarias</div>
                    </a>
                    <ul class="menu-sub">
                      <li class="menu-item">
                        <a href="dashboards-analytics.html" class="menu-link">
                          <i class='menu-icon bx bx-bullseye'></i>
                          <div data-i18n="Lista de metas diarias">Lista de metas diarias</div>
                        </a>
                      </li>
            ...
            <div class="row">
                <div class="col-lg-4 ms-auto">
                    <button class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#modalCargarVenta">Cargar venta</button>
                    <button class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#modalCrearMeta">Crear meta diaria</button>
                </div>
            </div>
            <?php
            include '../../db/conexion.php';
                $idUsuarios = $_SESSION["idUsuario"];
                $buscarMetas = $pdo->prepare("SELECT * FROM metasequipoventas");
                $buscarMetas->execute();
            ?>
          ...
          <div class="card">
                ...
                <table id="datatable" class="datatables-users table border-top table-bordered" data-page-length="10">
                    ...
                    <tbody>
                    <?php while ($row = $buscarMetas->fetch(PDO::FETCH_ASSOC)): ?>
                        <tr>

                            <td><?php echo $row['metasEquipoVentas_nombreProducto']; ?></td>
                            <td><?php echo $row['metasEquipoVentas_cantidad']; ?></td>
                            <td><?php echo $row['metasEquipoVentas_fechaCreacion']; ?></td>
                            <td><?php echo $row['metasEquipoVentas_fechaCreacion']; ?></td>
                            <td><button type="button" onclick="verMas(<?php echo $row['Id_metasEquipoVentas'];  ?>)" data-bs-toggle="modal" data-bs-target="#modalPorcentajeDeVentasVendedor" class="btn btn-label-info">Ver más</button></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
                </table>
            ...
            <?php include_once "../modal/modarCrearMetasVentas.php" ?>  
            <?php include_once "../modal/modalPorcentajedeCumplimientoVendedor.php" ?>     
            <?php include_once "../modal/modalCargarVenta.php" ?>            
            <!-- Footer -->
...
<script src="../../assets/js/extended-ui-sweetalert2.js"></script>
    ...
    <script>
      $("#btn-guardarMeta").on('click', function() {
    
            var formData = new FormData($('#Form-guardadMeta')[0]);
            $.ajax({
...
<script>
      $("#btn-guardarCantidadVendida").on('click', function() {
    
            var formData = new FormData($('#Form-guardarCantidadVendida')[0]);
            $.ajax({
                url: '../../php/metas/cargarCantidadVendida.php',
                type: 'post',
                data: formData,
                contentType: false,
                processData: false,
...
<script>
    function verMas(id){
      $.ajax({
        ...
        data: "id=" + id,
        success: function(r){
          $('#modal-body-modalPorcentajeDeVentasVendedor').html(r);
        }
    });
    }
  </script>
